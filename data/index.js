import companyData from './data/company-sample.json'
import positionsData from './data/positions-sample.json'
...
export default {
	...
	positions: {
		VJtH2JbtVPrCP2REKglu: {
			...
			title: 'Back-end',
			description: 'asjdh askjdb aksjj dhkajs hdkajs hdkjas hdkjj ashkd jhaksj dhhkasj hdhkkj ashkdjj haskdjj haskjd hkjhak sjdh kajsj hdkjajhkjhaksj hdkjas hdkjjash kdj asjdh jsh djas sjd askjdh aks',
